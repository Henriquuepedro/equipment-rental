                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <br>
                                        <br>
                                        <label><input {{ $disabled }} type="checkbox" id="whatsapp_phone_1" name="whatsapp_phone_1" {{ old('whatsapp_phone_1', $client->whatsapp_phone_1) ? 'checked' : '' }}> Número contém WhatsApp</label>
                                    </div>
                                    <div class="col-md-5">
                                        <br>
                                        <br>
                                        <label><input {{ $disabled }} type="checkbox" id="receiver_whatsapp_phone_1" name="receiver_whatsapp_phone_1" {{ old('receiver_whatsapp_phone_1', $client->receiver_whatsapp_phone_1) ? 'checked' : '' }}> Número de recebedor de mensagem do WhatsApp</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                    ...
                                    <div class="col-md-3">
                                        <br>
                                        <br>
                                        <label><input {{ $disabled }} type="checkbox" id="whatsapp_phone_2" name="whatsapp_phone_2" {{ old('whatsapp_phone_2', $client->whatsapp_phone_2) ? 'checked' : '' }}> Número contém WhatsApp</label>
                                    </div>
                                    <div class="col-md-5">
                                        <br>
                                        <br>
                                        <label><input {{ $disabled }} type="checkbox" id="receiver_whatsapp_phone_2" name="receiver_whatsapp_phone_2" {{ old('receiver_whatsapp_phone_2', $client->receiver_whatsapp_phone_2) ? 'checked' : '' }}> Número de recebedor de mensagem do WhatsApp</label>
                                    </div>
                                </div>
