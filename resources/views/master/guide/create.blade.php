        ...
        <div class="col-md-12 grid-margin">
            <div class="row flex-grow">
                <div class="col-12">
                    ...
                    @endif
                    <form action="{{ route('master.guide.insert') }}" method="POST" enctype="multipart/form-data" id="formCreateGuide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title" autocomplete="nope" value="{{ old('title') }}" required>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="card">
                                            <input type="file" name="file" class="dropify" data-allowed-file-extensions="pdf" required/>
                                        </div>
                                    </div>
                                </div>
                            </div>
