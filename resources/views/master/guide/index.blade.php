    ...
    <script>
        ...
        const getTable = (stateSave = true) => {
            return $("#tableGuides").DataTable({
                ...
                "order": [[ 0, 'desc' ]],
                "ajax": {
                    url: '{{ route('ajax.master.guide.fetch') }}',
                    pages: 2,
                    type: 'POST',
            ...
            <div class="card">
                <div class="card-body">
                    <div class="header-card-body justify-content-between flex-wrap">
                        ...
                        <a href="{{ route('master.guide.create') }}" class="mb-3 btn btn-primary col-md-3 btn-rounded btn-fw"><i class="fas fa-plus"></i> Novo Cadastro</a>
                    </div>
