                        ...
                        <div class="card-body">
                            <form action="{{ route($budget ? 'ajax.budget.new-rental' : 'ajax.rental.new-rental') }}" method="POST" enctype="multipart/form-data" id="formRental" class="pb-2">
                                ...
                                <div class="stepRental">
                                    <h6>Configuração {!! $budget ? 'do Orçamento' : 'da Locação <i class="fa fa-info-circle" data-bs-toggle="tooltip" data-placement="bottom" title="Defina se haverá ou não cobrança para essa locação."></i>' !!}</h6>
                                    <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group flatpickr">
                                            ...
                                            <input type="tel" name="expires_in" class="form-control col-md-9 pull-left mtr-0" value="" data-inputmask="'alias': 'datetime'" data-inputmask-inputformat="dd/mm/yyyy HH:MM" im-insert="false" data-input>
