...
@section('content_header')
    <h1 class="m-0 text-dark">Cadastro de Veículo</h1>
@stop
        ...
        <div class="col-md-12 d-flex align-items-stretch grid-margin">
            <div class="row flex-grow">
                <div class="col-12">
                    ...
                    @endif
                    <form action="{{ route(('vehicle.insert')) }}" method="POST" enctype="multipart/form-data" id="formCreateVehicle">
                        <div class="card">
                            <div class="card-body">
                                <div class="header-card-body">
                                    <h4 class="card-title">Dados do Veículo</h4>
                                    <p class="card-description"> Preencha o formulário abaixo com as informações do veículo </p>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" id="reference" name="reference" autocomplete="nope" value="{{ old('reference') }}">
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="brand" name="brand" autocomplete="nope" value="{{ old('brand') }}">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="model">Modelo</label>
                                        <input type="text" class="form-control" id="model" name="model" autocomplete="nope" value="{{ old('model') }}">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="board">Placa</label>
                                        <input type="text" class="form-control" id="board" name="board" autocomplete="nope" value="{{ old('board') }}">
                                    </div>
                                </div>
                                <div class="row">
