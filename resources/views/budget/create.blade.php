        ...
        <div class="col-md-12 d-flex align-items-stretch grid-margin">
            <div class="row flex-grow">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route(('ajax.rental.new-rental')) }}" method="POST" enctype="multipart/form-data" id="formRental" class="pb-2">
                                <h3>Tipo de Locação</h3>
                                <div class="stepRental">
                                    <h6>Tipo de Locação <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="bottom" title="Defina se haverá ou não cobrança para essa locação."></i></h6>
                                    <div class="row">
