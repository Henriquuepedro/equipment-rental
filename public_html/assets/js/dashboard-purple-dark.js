(function($) {
  ...
  $(function() {
    if ($("#performaneLinePurple-dark").length) { 
      const ctx = document.getElementById('performaneLinePurple-dark');
    ...
    if ($("#marketingOverviewPurple-dark").length) { 
      const marketingOverviewCanvas = document.getElementById('marketingOverviewPurple-dark');
    ...
    if ($("#doughnutChartPurple-dark").length) { 
      const doughnutChartCanvas = document.getElementById('doughnutChartPurple-dark');
    ...
    if ($("#leaveReportPurple-dark").length) { 
      const leaveReportCanvas = document.getElementById('leaveReportPurple-dark');
